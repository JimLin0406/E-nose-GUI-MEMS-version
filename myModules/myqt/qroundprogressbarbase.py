...
#######################################################
# Original is QRoundProgressBar for PyQt4.
#
# Sorce code got from: https://stackoverflow.com/questions/33577068/any-pyqt-circular-progress-bar
#
# Have been modified for Pyside2, and added "UF_STRING", "%s" to display string.
#
# Modified by Kevin Tung (NCKU.BME.2021)
#
...
class QRoundProgressBarBase(QWidget):
    ...
    def valueToText(self, value):
        ...
        if self.updateFlags & self.UF_STRING:
            textToDraw = textToDraw.replace("%s", str(value))
    ...
    def valueFormatChanged(self):
        ...
        if "%s" in self.format:
            self.updateFlags |= self.UF_STRING
